...
The application is running on (https://albertovelsan.shinyapps.io/myApp/)

ui.R, and Server.R Code in my github repository (https://github.com/albertovelsan/dataproducts)
